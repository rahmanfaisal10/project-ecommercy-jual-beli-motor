    ...
    <header class="header-global">
        <base-nav class="navbar-main" transparent type="" effect="light" expand>
            <router-link slot="brand" class="navbar-brand mr-lg-5" to="/">
                <img src="img/brand/motor-logo.png" alt="logo">
            </router-link>
            ...
            <ul class="navbar-nav align-items-lg-center ml-lg-center">
            <i class="ni ni-ui-04 d-lg-none"></i>
            <span class="nav-link-inner--text">JualBeMo</span>
            </ul>
            
            <ul class="navbar-nav navbar-nav-hover align-items-lg-auto">
